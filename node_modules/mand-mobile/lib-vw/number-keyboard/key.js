...
(function (global, factory) {
  ...
  exports.default = {
    ...
    methods: {
      $_onFocus: function $_onFocus(event, type) {
        if (!this.noPrevent) {
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.noTouch)?_c('li',{class:[_vm.active ? 'active' : ''],on:{"click":function($event){return _vm.$_onFocus($event, 'click')}}},[_c('span',{domProps:{"textContent":_vm._s(_vm.value)}})]):_c('li',{class:[_vm.active ? 'active' : ''],on:{"touchstart":function($event){return _vm.$_onFocus($event, 'touch')},"touchmove":_vm.$_onBlur,"touchend":_vm.$_onBlur,"touchcancel":_vm.$_onBlur,"click":function($event){return _vm.$_onFocus($event, 'click')}}},[_c('span',{domProps:{"textContent":_vm._s(_vm.value)}})])}
