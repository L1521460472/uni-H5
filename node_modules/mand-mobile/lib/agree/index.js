...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"md-agree",class:[
    _vm.disabled ? 'disabled' : ''
      ...
      _vm.value ? 'checked' : ''
    ],on:{"click":function($event){return _vm.$_onChange($event)}}},[_c('div',{staticClass:"md-agree-icon-container"},[_vm._t("icon",[(_vm.iconType === 'square')?_c('span',[_c('md-icon',{attrs:{"name":"square-checked","size":_vm.size}}),_vm._v(" "),_c('md-icon',{attrs:{"name":"square-check","size":_vm.size}})],1):_c('span',[_c('md-icon',{attrs:{"name":"checked","size":_vm.size}}),_vm._v(" "),_c('md-icon',{attrs:{"name":"check","size":_vm.size}})],1)],{"checked":_vm.value})],2)]),_vm._v(" "),_c('div',{staticClass:"md-agree-content"},[_vm._t("default")],2)])}
